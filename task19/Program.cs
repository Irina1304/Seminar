...
// метод, который получает сумму положительных чисел
int GetSumOfPositiveElements(int[] array)
{
    int sum = 0;
    for (int i = 0; i < array.Length; i++)
    {
...
int GetSumOfNegativeElements(int[] array)
{
    int sum = 0;
    for (int i = 0; i < array.Length; i++)
    {
...
int positiveSumm = GetSumOfPositiveElements(arr);
int negativeSumm = GetSumOfNegativeElements(arr);
